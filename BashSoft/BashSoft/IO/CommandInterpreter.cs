...
namespace BashSoft
{
    public static class CommandInterpreter
    {
        public static void InterpredCommand(string input)
        {
            ...
            switch (command)
            {
                ...
                case "cdAbs":
                    ...
                    break;
                case "readDb":
                    TryReadDatabaseFile(input, data);
                    break;
                case "help":
        ...
        private static void TryParseParametersForOrderAndTake(string courseName, string filter, string takeCommand, string takeQuantity)
        {
        ...
        static void TryShowWantedData(string input, string[] data)
        {
            if (data.Length == 2)
            {
                string courseName = data[1];
            ...
            else if (data.Length == 3)
            {
                ...
                StudentsRepository.GetStudentScoreFromCourse(courseName, studentName);
            }
            else
            {
                DisplayInvalidCommandMessage(input);
        ...
        static void TryGetHelp(string input, string[] data)
        {
        ...
        private static void TryReadDatabaseFile(string input, string[] data)
        {
            if (data.Length == 2)
            {
